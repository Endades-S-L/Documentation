...
- Click the **"To invoice"** checkbox to easily select the documents to include in the invoice.
...
- To create a grouped invoice for sales delivery notes, it is important that the document has the **Automatic invoicing** checkbox selected, which is located in the **Status observations** section.

    ![Sales delivery notes invoicing](Imagenes/PR_Facturas/facturacion_albaranes4.png)
...
- To generate an electronic invoice from ENBLAU, it is necessary that certain mandatory fields are completed in **Companies**, **Customers**, and **Payment Methods**.
    ...
    **Company:** The fields are VAT number, Address, City, Postal Code, Province, and Country. From the menu: Configuration - General - **Company**.
    ...
    ![Facturae company](Imagenes/PR_Facturas/facturae_empresa2.png)
    ...
    **Customers:** The fields are Trade Name, VAT/Tax ID, Country Code, and Type of Person (**J**: Legal entity, **F**: Individual). From the menu: Sales - **Customers**.
    ...
    ![Facturae customer](Imagenes/PR_Facturas/facturae_cliente2.png)
    ...
    **Payment Methods:** The field Legal Code. From the menu: Sales - Sales Documents - Configuration - **Payment Methods**.
    ...
    ![Facturae payment](Imagenes/PR_Facturas/facturae_formasdepago.png)
    
    ![Facturae payment](Imagenes/PR_Facturas/facturae_formasdepago2.png)
