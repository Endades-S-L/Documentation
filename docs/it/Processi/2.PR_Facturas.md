...
- Con un **clic** sulla casella della colonna **“Da fatturare”**, puoi selezionare facilmente i documenti da includere nella fattura.
...
- Per poter creare una fattura raggruppata per i documenti di trasporto di vendita, è importante che il documento abbia selezionata la casella **Fatturazione automatica**, che si trova nella sezione **Stati osservazioni**.

    ![Fatturazione documenti di trasporto di vendita](Imagenes/PR_Facturas/facturacion_albaranes4.png)
---
...
- Per generare una fattura elettronica da ENBLAU, è necessario che in **Aziende**, **Clienti** e **Metodi di pagamento** siano compilati alcuni campi obbligatori.
    ...
    **Azienda:** I campi sono Partita IVA, Indirizzo, Città, CAP, Provincia e Paese. Dal menu: Configurazione - Generale - **Azienda**.
    ...
    ![Facturae azienda](Imagenes/PR_Facturas/facturae_empresa2.png)
    
    ![Facturae azienda](Imagenes/PR_Facturas/facturae_empresa.png)
