...
- Com um **clique** sobre a caixa da coluna **“A faturar”**, você poderá selecionar facilmente os documentos que deseja incluir na fatura.
...
- Para que seja possível criar uma fatura agrupada para guias de remessa de vendas, é importante que o documento tenha a opção **Faturação automática** marcada, que se encontra na secção **Estados observações**.

    ![Faturação de guias de remessa de vendas](Imagenes/PR_Facturas/facturacion_albaranes4.png)
---
